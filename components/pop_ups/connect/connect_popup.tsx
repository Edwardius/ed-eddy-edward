  ...
  return (
    <div
      className={classNames(
        'flex fixed transition duration-300 items-center justify-center ease-in h-full w-screen bg-black bg-opacity-50',
    ...
    >
      {connect_open && (
        <div
          ...
          className='z-40 flex flex-col justify-center rounded h-1/4 w-1/4 bg-azukired-500'
        >
